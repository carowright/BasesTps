...
Testimonio(\underline{idTestimonio}, texto, hora, fecha, \dashuline{numeroPlacaPolicia\})
	PK = \{idTestimonio\}\\ 
	CK = \{idTestimonio\}\\ 
	FK = \{numeroPlacaPolicia\}\\ 

\newline
Evidencia(\underline{idEvidencia}, fechaIngreso, descripcion, fechaEncuentro, horaEncuentro, fechaSellado, horaSellado, \dashuline{idCaso})\\ 
	PK = \{idEvidencia\} \\
	CK = \{idEvidencia\}\\ 
	FK = \{idCaso\}\\ 

\newline
Custodia(\underline{idCustodia}, fecha, hora, comentario, \dashuline{idEvidencia}, \dashuline{numeroPlacaPolicia})\\ 
	PK = \{idCustodia\} \\
	CK = \{idCustodia\}\\ 
	FK = \{idEvidencia, numeroPlacaPolicia\}\\ 

\newline
Direccion(\underline{idDireccion}, numero, calle)\\ 
	PK = CK = \{idDireccion\}\\ 

\newline
CasoCriminal(\underline{idCaso}, fechaIngreso, fecha, hora, lugar, descripcion, \dashuline{nombreCategoria})\\ 
	PK = CK = \{idCaso\}\\ 
	FK = \{nombreCategoria\}\\ 
...
\newline
Resuelto(\underline{\underline{idCaso}}, fecha, descripcion, \dashuline{numeroPlacaPolicia}\)\\ 
	PK = CK = \{idCaso\}\\ 
	FK = \{numeroPlacaPolicia\}\\ 
